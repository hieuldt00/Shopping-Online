...
public class Product {
    ...
    public Product(int product_id, String product_name, int quantity, double price, String description, String detail, int status, int category_id, int shop_id, String image_thumbnail, Category category) {
